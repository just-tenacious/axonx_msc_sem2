  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12 animate-in fade-in duration-700 w-full min-h-screen mt-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-12">
        {papers.map((p, index) => (
          <div key={p._id || index} onClick={() => setSelectedPaper(p)} className="group bg-white dark:bg-slate-900 rounded-[48px] border border-slate-200 dark:border-slate-800 p-12 shadow-sm hover:shadow-2xl transition-all cursor-pointer flex flex-col text-left relative overflow-hidden">
